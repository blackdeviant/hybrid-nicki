...
HOSTCC = $(CCACHE) gcc
HOSTCXX = $(CCACHE) g++
HOSTCFLAGS = -DNDEBUG -pipe -Wall -Wmissing-prototypes -Wstrict-prototypes -Wno-unused-parameter -Wno-sign-compare -Wno-missing-field-initializers -Wno-unused-variable -Wno-unused-value -Ofast -fomit-frame-pointer $(GRAPHITE) -pthread -std=gnu89
...
KERNEL_FLAGS = -pipe -DNDEBUG -Ofast -marm -mtune=cortex-a15 -mcpu=cortex-a15 -mfpu=neon-vfpv4 -fmodulo-sched -fmodulo-sched-allow-regmoves $(GRAPHITE)
MOD_FLAGS	= -DMODULE $(KERNEL_FLAGS)
CFLAGS_MODULE = $(MOD_FLAGS) -fno-pic
